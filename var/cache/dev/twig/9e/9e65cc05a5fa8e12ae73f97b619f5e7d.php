...
class __TwigTemplate_e55a2983ddd1263627560fbcb7875161 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "conge/edit.html.twig", 1);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Edit Conge</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "conge/_form.html.twig", ["button_label" => "Update"]);
        echo "
    ...
    ";
        // line 12
        echo twig_include($this->env, $context, "conge/_delete_form.html.twig");
        echo "
";
...
{% block title %}Edit Conge{% endblock %}

{% block body %}
    <h1>Edit Conge</h1>

    {{ include('conge/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_conge_index') }}\">back to list</a>

    {{ include('conge/_delete_form.html.twig') }}
{% endblock %}
", "conge/edit.html.twig", "/home/miaro/Fianarana/ITU/S5/Mr_Tovo::Mr_Rojo/E_Manager/templates/conge/edit.html.twig");
    }
}
