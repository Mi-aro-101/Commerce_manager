...
/* header_achat.html.twig */
class __TwigTemplate_d806d396ee4838ffb7f0a513353e5321 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "header_achat.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "header_achat.html.twig"));
...
<div class=\"wrapper\">
  ...
  <aside class=\"main-sidebar sidebar-dark-primary elevation-4\">
    ...
    <a href=\"index3.html\" class=\"brand-link\">
      ...
      <span class=\"brand-text font-weight-light\">Achat</span>
    </a>
    ...
    <div class=\"sidebar\">
      ...
      <nav class=\"mt-2\">
        ...
        echo "\" class=\"nav-link ";
        echo (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 119, $this->source); })()), "request", [], "any", false, false, false, 119), "get", ["_route"], "method", false, false, false, 119) == "app_article_new")) ? ("active") : (""));
        echo "\">
              ...
              <li class=\"nav-item\">
                <a href=\"";
        // line 125
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_mode_paiment_new");
        echo "\" class=\"nav-link ";
        echo (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 125, $this->source); })()), "request", [], "any", false, false, false, 125), "get", ["_route"], "method", false, false, false, 125) == "app_mode_paiment_new")) ? ("active") : (""));
        echo "\">
        ...
        echo "\" class=\"nav-link ";
        echo (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 131, $this->source); })()), "request", [], "any", false, false, false, 131), "get", ["_route"], "method", false, false, false, 131) == "app_fournisseur_new")) ? ("active") : (""));
        echo "\">
              ...
              <li class=\"nav-item\">
                <a href=\"";
        // line 137
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_article_fournisseur_new");
        echo "\" class=\"nav-link ";
        echo (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 137, $this->source); })()), "request", [], "any", false, false, false, 137), "get", ["_route"], "method", false, false, false, 137) == "app_article_fournisseur_new")) ? ("active") : (""));
        echo "\">
                  <ion-icon name=\"briefcase-sharp\"></ion-icon>
                  <p>Article d'un fournisseur</p>
                </a>
              </li>
            </ul>
          </li>
    ...
    {
        return array (  243 => 137,  232 => 131,  221 => 125,  210 => 119,  198 => 110,  171 => 88,  165 => 85,  153 => 76,  138 => 64,  115 => 44,  101 => 33,  91 => 26,  86 => 24,  81 => 22,  76 => 20,  71 => 18,  66 => 16,  61 => 14,  54 => 10,  43 => 1,);
    }
...
<div class=\"wrapper\">
  ...
  <aside class=\"main-sidebar sidebar-dark-primary elevation-4\">
      ...
      <nav class=\"mt-2\">
        <ul class=\"nav nav-pills nav-sidebar flex-column\" data-widget=\"treeview\" role=\"menu\" data-accordion=\"false\">
          ...
          <li class=\"nav-item\">
            ...
            <ul class=\"nav nav-treeview\">
              <li class=\"nav-item\">
                <a href=\"{{ path('app_article_new') }}\" class=\"nav-link {{ app.request.get('_route') == 'app_article_new' ? 'active' }}\">
                  <ion-icon name=\"bag-add-sharp\"></ion-icon>
                  <p>Article</p>
                </a>
              </li>
              <li class=\"nav-item\">
                <a href=\"{{ path('app_mode_paiment_new') }}\" class=\"nav-link {{ app.request.get('_route') == 'app_mode_paiment_new' ? 'active' }}\">
                  <ion-icon name=\"card-sharp\"></ion-icon>
                  <p>Mode de paiment</p>
                </a>
              </li>
              <li class=\"nav-item\">
                <a href=\"{{ path('app_fournisseur_new') }}\" class=\"nav-link {{ app.request.get('_route') == 'app_fournisseur_new' ? 'active' }}\">
                  <ion-icon name=\"briefcase-sharp\"></ion-icon>
                  <p>Founisseur</p>
                </a>
              </li>
              <li class=\"nav-item\">
                <a href=\"{{ path('app_article_fournisseur_new') }}\" class=\"nav-link {{ app.request.get('_route') == 'app_article_fournisseur_new' ? 'active' }}\">
                  <ion-icon name=\"briefcase-sharp\"></ion-icon>
                  <p>Article d'un fournisseur</p>
                </a>
              </li>
    ...
    <!-- /.sidebar -->
  </aside>", "header_achat.html.twig", "/home/miaro/Fianarana/ITU/S5/Mr_Tovo::Mr_Rojo/E_Manager/templates/header_achat.html.twig");
    }
}
